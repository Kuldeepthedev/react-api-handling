...
var apiRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(method, endpoint) {
    var data,
      headers,
      params,
      apiUrl,
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return apiClient({
            method: method,
            url: endpoint,
            // Endpoint is relative to baseURL
            data: data,
            headers: headers,
            params: params
          });
 ...
 */
var useDelete = function useDelete(apiUrlWithEndpoint) {
  var _retryOptions$retryCo, _retryOptions$retryDe;
  var headers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var queryKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  var mutation = useMutation( /*#__PURE__*/function () {
    ...
    retry: (_retryOptions$retryCo = retryOptions.retryCount) !== null && _retryOptions$retryCo !== void 0 ? _retryOptions$retryCo : 3,
    // Default retry count
    retryDelay: (_retryOptions$retryDe = retryOptions.retryDelay) !== null && _retryOptions$retryDe !== void 0 ? _retryOptions$retryDe : 1000,
    // Default retry delay
 ...
 */
var useGet = function useGet(apiUrlsWithEndpoints) {
  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var headers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var queryOptions = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  var paginationOptions = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
  var cacheOptions = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
  var interceptors = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : {};
  var transformData = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : function (data) {
    return data;
  };
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", interceptors.response(response));
          case 7:
            return _context.abrupt("return", transformData(response));
          case 8:
          case "end":
            return _context.stop();
        }
 ...
 * @returns {Object} - The mutation result object with enhanced features.
 */
var usePost = function usePost(apiUrlWithEndpoint) {
  var _retryOptions$retryCo, _retryOptions$retryDe;
  var headers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var queryKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var interceptors = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
...
/**
 * Custom hook for performing PUT requests with advanced features.
 *
 * @param {string} apiUrlWithEndpoint - The full URL for the API including the endpoint.
 * @param {Object} [headers={}] - Optional headers.
 * @param {string|null} [queryKey=null] - Optional query key to invalidate upon success.
 ...
 * @returns {Object} - The mutation result object with enhanced features.
 */
var usePut = function usePut(apiUrlWithEndpoint) {
  var _retryOptions$retryCo, _retryOptions$retryDe;
  var headers = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var queryKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var interceptors = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
...
var QueryClientProvider = function QueryClientProvider(props) {
  ...
  return /*#__PURE__*/React__default.createElement(QueryClientProvider$1, {
    client: queryClient
  }, props.children);
};

export { QueryClientProvider, queryClient, useDelete, useGet, usePost, usePut };
